  ...
  <div class="col-md-12 container">
      ...
      <div class="card-header bg-secondary card_header">
          <div class="row">
            ...
            <?php if ($_SESSION['role']=='Admin' ) { ?>
              ...
              <a href="wbvirus.php" class="btn btn-xs btn-dark " style="float: right; color:white;"><i class="fas fa-plus-circle"></i>ADD Should Do</a>
              <?php }?>
            </div>
          </div>
      </div>  
    ...
    <div class="card-body container">
        <table class="table table-bordered table-striped table-hover custom_table">
          ...
          <?php
          $sel="SELECT * FROM wbvirus  ORDER BY id DESC";
            ...
            <td><?=substr($data['decp'],0,30);?></td>
             <td>
                ...
                <?php
                  if ($data['img']!='') {
                ?>
                  <img height="70px" src="../upload/Symptoms/<?=$data['img'] ?>"/>
							<?php   }else{ ?>
                ...
                <td>
                  ...
                  <a href="wbsymdelete.php?delet=<?=$data['id'];?>"><i class="fas fa-trash-alt fa-lg"></i></a>
