    ...
    <div class="card-body container">
        <table class="table table-bordered table-striped table-hover custom_table">
          <thead class="thead-dark">
            ...
            <th scope="col">Friquently Questions </th>
            <th scope="col">Friquently Answer </th>
          ...
          $sel="SELECT * FROM webfq ORDER BY fq_id DESC ";
          $alq=mysqli_query($con,$sel);
          while ($data=mysqli_fetch_assoc($alq)) {
          ?>
            <tr>
               
            <td><?=substr($data['fq_qus'],0,50);?></td>
            <td><?=substr($data['fq_ans'],0,60) ;?></td>

                <?php if ($_SESSION['role']=='Admin' ) { ?>
                <td>
                 
                  <a href="wbdeletecon.php?delet=<?=$data['fq_id'];?>"><i class="fas fa-trash-alt fa-lg"></i></a>
