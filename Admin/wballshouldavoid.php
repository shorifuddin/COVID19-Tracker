  ...
  <div class="col-md-12 container">
      ...
      <div class="card-header bg-secondary card_header">
          <div class="row">
            <div class="col-md-8 card_header_title">
              <i class="fab fa-gg-circle "></i> All Prevention Should Avoid
            </div>
            <?php if ($_SESSION['role']=='Admin' ) { ?>
              <div class="col-md-4 card_header_btn ">
              <a href="wballshouldavoid.php" class="btn btn-xs btn-dark " style="float: right; color:white;"><i class="fas fa-plus-circle"></i>ADD Should Avoid</a>
              <?php }?>
            </div>
          </div>
      </div>  
    ...
    <div class="card-body container">
        <table class="table table-bordered table-striped table-hover custom_table">
          ...
          $sel="SELECT * FROM preavoid  ORDER BY id DESC";
