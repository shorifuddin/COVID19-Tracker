  ...
  <div class="col-md-12 container">
    ...
    <div class="card-body container">
        <table class="table table-bordered table-striped table-hover custom_table">
          ...
          $sel="SELECT * FROM user_info NATURAL JOIN user_role ORDER BY user_id DESC";
          ...
          ?>
            ...
            <td><?=$data['role_name'];?></td>
                ...
                <?php if ($_SESSION['role']=='Admin' ) { ?>
                <td>
                  <a href="viewuser.php?view=<?=$data['user_id'];?>"><i class="fas fa-eye fa-lg"></i></a>

                  <a href="edituser.php?edit=<?=$data['user_id'];?>"><i class="fas fa-edit fa-lg"></i></a>

                  <a href="deleteuser.php?delet=<?=$data['user_id'];?>"><i class="fas fa-trash-alt fa-lg"></i></a>
